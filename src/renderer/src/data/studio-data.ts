...
const EXPERTS: Expert[] = [
  ...
  { id: 'designer', name: 'Georgia', color: 'var(--exp-designer)', specialty: 'Designer — images & posters', personality: 'Creative, opinionated', model: 'imagen-4', family: 'gemini' },
  { id: 'translator', name: 'Louise', color: 'var(--exp-translator)', specialty: 'Translator — any language pair', personality: 'Precise, culturally aware', model: 'gemini-3.1-flash-lite', family: 'gemini' },
...
const ROLE_BINDINGS: RoleBinding[] = [
  ...
  { id: 'designer', family: 'gemini', model: 'imagen-4' },
  { id: 'translator', family: 'gemini', model: 'gemini-2.5-flash' },
  { id: 'editor', family: 'gemini', model: 'gemini-2.5-flash' },
