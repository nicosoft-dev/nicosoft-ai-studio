...
export type GitWorkStatus = NonNullable<Awaited<ReturnType<typeof window.api.git.status>>>
export type GitWorkDiff = NonNullable<Awaited<ReturnType<typeof window.api.git.diff>>>
export type GitFileDiff = GitWorkDiff['files'][number]
