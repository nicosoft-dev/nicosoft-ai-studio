...
export type AsyncHandleDto = Parameters<Parameters<typeof window.api.onConvAsync>[0]>[0]['handles'][number]
export type RhythmWakeupDto = Awaited<ReturnType<typeof window.api.rhythm.list>>[number]
export type MonitorInfo = Awaited<ReturnType<typeof window.api.monitor.list>>[number]
