// ToolBubble + DiffView — renders a tool the Hex agent ran inside an assistant message. Visual design
// from claude.ai/design ("Hex · coding-agent components"): a compact row with a status indicator
